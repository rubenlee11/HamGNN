...
/*******************************************************
  added by Xiwen Li
 double *Vlr_Grid; 
  Hartree potential generated by point charge on Cnt
  size: Vlr_Grid[Matomnum+MatomnumF+MatomnumS+1][My_Max_NumGridB]
  allocation: allocate in truncation.c
  free:       call as Free_Arrays(0) in openmx.c
*******************************************************/
double **Vlr_Grid;
...
/*******************************************************
 ...
 double *Vlr_Grid_B; 
  Hartree potential generated by point charge on Cnt
  on grids in the partition B
  size: Vlr_Grid_B[Matomnum+MatomnumF+MatomnumS+1][My_Max_NumGridB]
  allocation: allocate in truncation.c
  free:       call as Free_Arrays(0) in openmx.c
*******************************************************/
double **Vlr_Grid_B;
...
/*******************************************************
 double *****Hlr;
  long range Coulomb potential matrix elements of basis orbitals
  size: Hlr[Matomnum+MatomnumF+MatomnumS+1]
           [Matomnum+MatomnumF+MatomnumS+1]
           [FNAN[Gc_AN]+1]
           [Spe_Total_NO[Cwan]]
           [Spe_Total_NO[Hwan]] 
